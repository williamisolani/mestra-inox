...
const stats = [
  ...
  { value: "+5000", label: "projetos entregues" },
...
const differentials = [
  {
    ...
    text: "Produção 100% verticalizada, do projeto à entrega.",
  },
  {
    icon: Ruler,
    title: "Projetos sob medida",
    text: "Cada cozinha é desenhada para sua operação.",
  },
  {
    icon: ShieldCheck,
    title: "Inox certificado",
    text: "Matéria-prima com composição controlada e rastreada.",
  },
  {
    icon: Wrench,
    title: "Suporte técnico",
    text: "Assistência pós-venda e orientação de instalação.",
  },
  {
    icon: TrendingUp,
    title: "Alta performance",
    text: "Equipamentos para operações de grande demanda.",
  },
  {
    icon: Users,
    title: "Atendimento consultivo",
    text: "Equipe especializada do orçamento à entrega.",
  },
];
    ...
    <div className="container">
      <AnimatedSection className="text-center mb-16">
        ...
        <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
          Há 30 anos, a Mestra Inox entrega soluções para quem leva a cozinha
          profissional a sério. Confiança, qualidade e resultado em cada
          projeto.
        </p>
      </AnimatedSection>
